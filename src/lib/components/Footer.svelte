...
<footer id="contact" class="border-b border-grid-lines">
  <div class="container">
    <div class="grid grid-auto-rows lg:grid-cols-6 border-x border-b border-grid-lines">
      <!-- Branding -->
      <div class="col-span-full lg:col-span-3 p-8 border-b lg:border-r lg:border-b-0 border-grid-lines">
      ...
      <div class="col-span-full lg:col-span-3">
        <ul id="social-platforms" class="grid grid-rows-auto lg:grid-cols-3">
          <li class="border-b lg:border-r lg:border-b-0 border-grid-lines"><a href="https://github.com/randydaniel" rel="noreferrer" target="_blank" class="block p-8 w-full h-full text-center text-2xl underline hover:no-underline hover:bg-primary transition transition-duration-300 ease-in-out">GitHub<sup class="text-md ml-2">↗</sup></a></li>
          <li class="border-b lg:border-r lg:border-b-0 border-grid-lines"><a href="https://www.linkedin.com/in/randymdaniel/" rel="noreferrer" target="_blank" class="block p-8 w-full h-full text-center text-2xl underline hover:no-underline hover:bg-primary transition transition-duration-300 ease-in-out">Linkedin<sup class="text-md ml-2">↗</sup></a></li>
